...
A React component that presents a simple TreeTable, allowing the user to supply styling and rendering options. A default styling (using Bootstrap 5) is also available.

## Version 3 update

This is essentially a re-write of the component, using modern technology (React 18, Bootstrap 5) and resolving many issues with the previous version.
